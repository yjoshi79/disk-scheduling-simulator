...
const CSCANSim = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (direction === "right") {
      ...
      // Jump to the beginning and process remaining requests
      ...
      // Jump to the end and process remaining requests
      if (remaining.length > 0) {
  ...
  return (
    <div className="sim-page-bg">
      <div className="fcfs-info-card">
        <h2 className="sim-title">C-SCAN Disk Scheduling Simulation</h2>
        <p className="sim-desc">
          C-SCAN (Circular SCAN) moves the disk arm in one direction, servicing requests along the way. When it reaches the end, it jumps to the beginning and continues in the same direction.
        </p>
        <hr />
        <p className="sim-note">
          <em>
            C-SCAN provides more uniform waiting time than SCAN and is better for systems with heavy loads.
          </em>
        </p>

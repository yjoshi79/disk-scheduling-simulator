  ...
  return (
    <div className="sim-page-bg">
      <div className="fcfs-info-card">
        <h2 className="sim-title">LOOK Disk Scheduling Simulation</h2>
        <p className="sim-desc">
          LOOK moves the disk arm towards the nearest request in one direction, then reverses at the last request.
        </p>
        <hr />
        <p className="sim-note">
          <em>
            LOOK is more efficient than SCAN as it only goes as far as the last request in each direction.
          </em>
        </p>
